Function script:Set-INFFile {
    ...
    Param (
        ...
        [String]$CommandToExecute = "C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe -NoProfile -Command Start-Process notepad.exe `"$env:temp\DriverUpdater\example.txt`""
    )
